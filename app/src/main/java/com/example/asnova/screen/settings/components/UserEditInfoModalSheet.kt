...
@Composable
fun UserEditInfoModalSheet(
    viewModel: SettingsScreenViewModel,
    showBottomSheet: Boolean,
    onDismiss: () -> Unit,
    onSubmit: (String, String, String, String) -> Unit
) {
    var name by remember { mutableStateOf(viewModel.userData?.name ?: "") }
    var surname by remember { mutableStateOf(viewModel.userData?.surname ?: "") }
    var email by remember { mutableStateOf(viewModel.userData?.email ?: "") }
    var phone by remember { mutableStateOf(viewModel.userData?.phone ?: "") }
